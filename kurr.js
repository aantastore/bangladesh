...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = kurr.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© WIBU BOT_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             kurr.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = kurr.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/JmxvsLgw3KM1x9VHmsk0wq', "groupName": `${NamaBot}`, "footerText": "*_© WIBU BOT_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
cpref = `Hayo Ngomongin WIBU BOT Ganteng Yaaa Aowkowkwoo`
reply(cpref)
}
if(budy.includes('WIBU BOT')){
cpref = `Hayo Ngomongin WIBU BOT Ganteng Yaaa Aowkowkwoo`
reply(cpref)
}
           if (budy.startsWith('>')){
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_© WIBU BOT_*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('http://instagram.com/xenonsadboy')
}
if(isButton == 'ytm'){
reply('http://youtube.com/c/Xenon Bot')
}
...
𝘘𝘜𝘖𝘛𝘌𝘚  : ${quotes}
└─────────────────❒`
sendButLocation(from, `${menu}`, "*_© WIBU BOT_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`store`,buttonText:{displayText:'𝙨𝙩𝙤𝙧𝙚 𝙢𝙚𝙣𝙪'},type:1},{buttonId:`sc`,buttonText:{displayText:'SC'},type:1},{buttonId:`catalog`,buttonText:{displayText:'CATALOG MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
𝘘𝘜𝘖𝘛𝘌𝘚  : ${quotes}`
sendButLocation(from, `${menu}`, "*_© WIBU BOT_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`allmenu`,buttonText:{displayText:'ALL MENU'},type:1},{buttonId:`rules`,buttonText:{displayText:'RULES'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
*INFORMATION:*
- BOT ON 24 JAM
- KALAU OFF BERARTI LAGI ADA MASALAH ATAU LAGI SETTING

*RULES:*
- DILARANG SPAM BOT
- DILARANG CALL BOT ( BLOCK )
- GUNAKAN SEWAJAR NYA AJA
...
📥 BERMINAT ? HUBUNGI :
wa.me/+16146607969 ( Xenon )


*MATURSUWUN MONGGO DI LARISI*`
sendButLocation(from, `${menu}`, "*_© WIBU BOT_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`menu`,buttonText:{displayText:'BACK TO MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
MY GITHUB
[https://github.com/WiZXD]

MY YOUTUBE
[https://youtube.com/c/Xenon Bot
   `
menu =`WIBU BOT`
gbutsan = [
...
ɢɪᴛʜᴜʙ ᴏᴡɴᴇʀ:https://github.com/WiZXD
ʸᵒᵘᵗᵘᵇᵉ ᵒʷⁿᵉʳ:https://youtube.com/c/Xenon Bot`
sendButLocation(from, `${menu}`, "*_© WIBU BOT_*", {jpegThumbnail:logonya,name:""}, [{buttonId:`menu`,buttonText:{displayText:'SIAP OM'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
case 'verify':
...
case 'chiisaihentai':
              ...
              buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await kurr.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'✗✗✗ WIBU BOT', imageMessage: imageMsg,
              contentText:`Subrek yt : Xenon Bot`,buttons,headerType:4}
              prep = await kurr.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol})
              kurr.relayWAMessage(prep)
                    break
case 'bj':
...
case 'blackpink':
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    ...
                    getBuffer(`https://api.lolhuman.xyz/api/textprome/${command}?apikey=KurrXd&text=${ini_txt}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Subrek yt : Xenon Bot`, quoted : ftrol})
                    })
                    break
                case 'pornhub':
                case 'glitch':
...
kurr.sendMessage(from, {url: `${pint[Math.floor(Math.random() * pint.length)]}`}, image, {quoted: mek, thumbnail: Buffer.alloc(0), caption: "Subscribe Xenon Bot"})
break
case 'isbaileys': 
case 'bail': 
case 'baileys':
